          ...
          <div className="grid">
            ...
            <form action="https://httpbin.org/post" method="POST" className="form login">
              ...
              <div className="form__field">
                <label ><svg className="icon"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#user"></use></svg><span className="hidden">Username</span></label>
              ...
              <div className="form__field">
                <label><svg className="icon"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#email"></use></svg><span className="hidden">Password</span></label>
                <input id="login__email" type="text" name="email" className="form__input" placeholder="Email" required ref={(email) => this.email = email}/>
              </div>

              <div className="form__field">
                <label><svg className="icon"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#lock"></use></svg><span className="hidden">Password</span></label>
