                ...
                <div className="dashboard" key={1}>         
                    <div className="tabs">
                        {this.state.uploadTab &&
                            <div className="tabs__fullupload">
                                <div className="tabs__upload">
                                    ...
                                    <span className="tabs--span"></span>
                                    <input type="button" className="tabs--button" value="Close"/>
                                </div>
                    ...
                    <div className="sections">
                        ...
                        <div className="sections__upload" onClick={this.handleClickUpload}>
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                viewBox="0 0 486.3 486.3" xmlSpace="preserve" alt="Log out">
                                <g>
