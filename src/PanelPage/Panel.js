          ...
          <ul className="nav__menu">
            ...
            <li>
              <img
                src={downArrow}
                alt="downArrow"
                className="nav__icon2"
                onClick={this.showProfileTab}
              />
            </li>
          </ul>
          {showProfileTab ? <div className="nav__wrapper"></div> : <div></div>}
        </nav>
        <div className="content">
          <aside>
            <a href="/dashboard">
              <svg
                className={this.state.monitorTab}
                ...
                <defs>
                  <linearGradient
                    ...
                    <stop
                      offset="0%"
                      style={{stopColor: "rgb(255,32,32)", stopOpacity: 1}}
                    />
                    <stop
                      offset="99%"
                      style={{stopColor: "rgb(255,74,38)", stopOpacity: 1}}
                    />
                    <stop
                      offset="100%"
                      style={{stopColor: "rgb(255,74,38)", stopOpacity: 1}}
            ...
            <svg
              ...
              <g>
                <path
                  d="M53.924,24.382c0.101-0.244,0.101-0.519,0-0.764c-0.051-0.123-0.125-0.234-0.217-0.327L41.708,11.293
