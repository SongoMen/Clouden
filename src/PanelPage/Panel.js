        ...
        <nav className="nav__bar">
          ...
          <div className="asideMenu">
            <aside>
              ...
              <svg version="1.1" className="section__exit" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 55 55" xmlSpace="preserve" onClick = {() => {logout()}}>
                <g>
